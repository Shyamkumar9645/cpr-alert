...
def setup_environment_file():
    ...
    """
    # Create the path to the .env file in the parent directory (project root)
    ...
    print("\n--- 🔐 Secure Setup for API Credentials ---")
...
"""
    ...
    print("\nNext steps:")
    print("1. Run 'pip install -r requirements.txt' if you haven't already.")
