    ...
    def load_config() -> Dict[str, Any]:
        ...
        config = {
            ...
            'assets': [
                ...
                {'symbol': 'NSE:TCS-EQ', 'name': 'TCS', 'type': 'stock', 'category': 'IT'},
                ...
                {'symbol': 'NSE:BHARTIARTL-EQ', 'name': 'BHARTI AIRTEL', 'type': 'stock', 'category': 'TELECOM'},
                {'symbol': 'NSE:INFY-EQ', 'name': 'INFOSYS', 'type': 'stock', 'category': 'IT'},
                {'symbol': 'NSE:SBIN-EQ', 'name': 'STATE BANK', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:LICI-EQ', 'name': 'LIC INDIA', 'type': 'stock', 'category': 'INSURANCE'},
                {'symbol': 'NSE:ITC-EQ', 'name': 'ITC', 'type': 'stock', 'category': 'FMCG'},
                {'symbol': 'NSE:HCLTECH-EQ', 'name': 'HCL TECH', 'type': 'stock', 'category': 'IT'},
                {'symbol': 'NSE:BAJFINANCE-EQ', 'name': 'BAJAJ FINANCE', 'type': 'stock', 'category': 'FINANCE'},
                {'symbol': 'NSE:LT-EQ', 'name': 'L&T', 'type': 'stock', 'category': 'ENGINEERING'},
                {'symbol': 'NSE:SUNPHARMA-EQ', 'name': 'SUN PHARMA', 'type': 'stock', 'category': 'PHARMA'},
                {'symbol': 'NSE:WIPRO-EQ', 'name': 'WIPRO', 'type': 'stock', 'category': 'IT'},
                {'symbol': 'NSE:AXISBANK-EQ', 'name': 'AXIS BANK', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:ASIANPAINT-EQ', 'name': 'ASIAN PAINTS', 'type': 'stock', 'category': 'PAINTS'},
                {'symbol': 'NSE:MARUTI-EQ', 'name': 'MARUTI SUZUKI', 'type': 'stock', 'category': 'AUTO'},
                {'symbol': 'NSE:TITAN-EQ', 'name': 'TITAN', 'type': 'stock', 'category': 'JEWELLERY'},
                {'symbol': 'NSE:COALINDIA-EQ', 'name': 'COAL INDIA', 'type': 'stock', 'category': 'MINING'},
                {'symbol': 'NSE:NTPC-EQ', 'name': 'NTPC', 'type': 'stock', 'category': 'POWER'},
                {'symbol': 'NSE:NESTLEIND-EQ', 'name': 'NESTLE', 'type': 'stock', 'category': 'FMCG'},
                {'symbol': 'NSE:ULTRACEMCO-EQ', 'name': 'ULTRA CEMENT', 'type': 'stock', 'category': 'CEMENT'},
                {'symbol': 'NSE:ONGC-EQ', 'name': 'ONGC', 'type': 'stock', 'category': 'OIL_GAS'},
                {'symbol': 'NSE:JSWSTEEL-EQ', 'name': 'JSW STEEL', 'type': 'stock', 'category': 'STEEL'},
                {'symbol': 'NSE:POWERGRID-EQ', 'name': 'POWER GRID', 'type': 'stock', 'category': 'POWER'},
                {'symbol': 'NSE:BAJAJFINSV-EQ', 'name': 'BAJAJ FINSERV', 'type': 'stock', 'category': 'FINANCE'},
                {'symbol': 'NSE:HINDALCO-EQ', 'name': 'HINDALCO', 'type': 'stock', 'category': 'METALS'},
                {'symbol': 'NSE:TECHM-EQ', 'name': 'TECH MAHINDRA', 'type': 'stock', 'category': 'IT'},
                {'symbol': 'NSE:HDFCLIFE-EQ', 'name': 'HDFC LIFE', 'type': 'stock', 'category': 'INSURANCE'},
                {'symbol': 'NSE:SBILIFE-EQ', 'name': 'SBI LIFE', 'type': 'stock', 'category': 'INSURANCE'},
                {'symbol': 'NSE:ADANIENT-EQ', 'name': 'ADANI ENTERPRISES', 'type': 'stock', 'category': 'DIVERSIFIED'},
                {'symbol': 'NSE:APOLLOHOSP-EQ', 'name': 'APOLLO HOSPITAL', 'type': 'stock', 'category': 'HEALTHCARE'},
                {'symbol': 'NSE:HEROMOTOCO-EQ', 'name': 'HERO MOTOCORP', 'type': 'stock', 'category': 'AUTO'},
                {'symbol': 'NSE:INDUSINDBK-EQ', 'name': 'INDUSIND BANK', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:CIPLA-EQ', 'name': 'CIPLA', 'type': 'stock', 'category': 'PHARMA'},
                {'symbol': 'NSE:GRASIM-EQ', 'name': 'GRASIM', 'type': 'stock', 'category': 'CHEMICALS'},
                {'symbol': 'NSE:BRITANNIA-EQ', 'name': 'BRITANNIA', 'type': 'stock', 'category': 'FMCG'},
                {'symbol': 'NSE:DRREDDY-EQ', 'name': 'DR REDDY', 'type': 'stock', 'category': 'PHARMA'},
                {'symbol': 'NSE:EICHERMOT-EQ', 'name': 'EICHER MOTORS', 'type': 'stock', 'category': 'AUTO'},
                {'symbol': 'NSE:DIVISLAB-EQ', 'name': 'DIVI\'S LAB', 'type': 'stock', 'category': 'PHARMA'},
                {'symbol': 'NSE:TATAMOTORS-EQ', 'name': 'TATA MOTORS', 'type': 'stock', 'category': 'AUTO'},
                {'symbol': 'NSE:TATASTEEL-EQ', 'name': 'TATA STEEL', 'type': 'stock', 'category': 'STEEL'},
                {'symbol': 'NSE:ADANIPORTS-EQ', 'name': 'ADANI PORTS', 'type': 'stock', 'category': 'INFRASTRUCTURE'},
                {'symbol': 'NSE:TATACONSUM-EQ', 'name': 'TATA CONSUMER', 'type': 'stock', 'category': 'FMCG'},
                {'symbol': 'NSE:BAJAJ-AUTO-EQ', 'name': 'BAJAJ AUTO', 'type': 'stock', 'category': 'AUTO'},
                {'symbol': 'NSE:SHRIRAMFIN-EQ', 'name': 'SHRIRAM FINANCE', 'type': 'stock', 'category': 'FINANCE'},
                {'symbol': 'NSE:KOTAKBANK-EQ', 'name': 'KOTAK BANK', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:BPCL-EQ', 'name': 'BPCL', 'type': 'stock', 'category': 'OIL_GAS'},
                {'symbol': 'NSE:LTIM-EQ', 'name': 'LTI MINDTREE', 'type': 'stock', 'category': 'IT'},
                {'symbol': 'NSE:HINDUNILVR-EQ', 'name': 'HINDUSTAN UNILEVER', 'type': 'stock', 'category': 'FMCG'},
                {'symbol': 'NSE:M&M-EQ', 'name': 'M&M', 'type': 'stock', 'category': 'AUTO'},
                {'symbol': 'NSE:FEDERALBNK-EQ', 'name': 'FEDERAL BANK', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:IDFCFIRSTB-EQ', 'name': 'IDFC FIRST BANK', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:BANKBARODA-EQ', 'name': 'BANK OF BARODA', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:PNB-EQ', 'name': 'PUNJAB NATIONAL BANK', 'type': 'stock', 'category': 'BANKING'},
                {'symbol': 'NSE:AUBANK-EQ', 'name': 'AU SMALL FINANCE BANK', 'type': 'stock', 'category': 'BANKING'}
            ],
            'alert_settings': {
